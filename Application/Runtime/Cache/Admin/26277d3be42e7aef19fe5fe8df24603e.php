...
<div id="body-wrapper" /> <!-- Wrapper for the radial gradient background -->
	...
	<ul>
		...
		<li><a class="current" href="#">编辑任务</a></li>
		<!--
						...
						<form action="/myProject/thinkphpFrame/index.php/Admin/Task/update" method="post" name="task_form">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									...
									<input type="hidden" name="task_img_url" id="task_img_url" value="<?php echo ($data["task_img_url"]); ?>">
								</p>
								...
								<p>
									<label>商家品牌介绍<span style="color:red">(*注意图片上传宽度为640)</span></label>
								...
								<p>
									<label>征集活动介绍<span style="color:red">(*注意图片上传宽度为640)</span></label>
