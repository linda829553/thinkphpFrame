...
<div id="body-wrapper" /> <!-- Wrapper for the radial gradient background -->
	...
	<ul>
		<li><a class="current" href="/myProject/thinkphpFrame/index.php/Admin/News/index">发布新闻</a></li>
			...
			<div class="content-box" id="member-manage"><!-- Start Content Box -->
				...
				<div class="content-box-content">
						...
						<table>
							...
							<tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<?php switch($vo["cat_id"]): case "1": ?><td>站内链接</td><?php break;?>
										<?php case "2": ?><td>合作伙伴</td><?php break;?>
										<?php case "3": ?><td>爱车保养</td><?php break;?>
										<?php case "4": ?><td>经典案例</td><?php break; endswitch;?>
									<td><?php echo (mb_substr(strip_tags(htmlspecialchars_decode($vo["content"])),0,65,'utf-8')); ?></td>
									<td><?php echo ($vo["post_man"]); ?></td>
									<td><?php echo (date('Y-m-d',$vo["post_time"])); ?></td>
									<td>
										<!-- Icons -->
					...
					<div class="tab-content" id="tab2">
						...
						<form action="/myProject/thinkphpFrame/index.php/Admin/News/insert" method="post" name="news_form">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>作者：</label>
									<input class="text-input" type="text" id="post_man" name="post_man" value="admin" />
								</p>
