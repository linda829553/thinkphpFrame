...
<div id="body-wrapper" /> <!-- Wrapper for the radial gradient background -->
	...
	<ul>
		<li><a class="current" href="/myProject/thinkphpFrame/index.php/Admin/Task/index">发布任务</a></li>
		<!--
			...
			<div class="content-box" id="member-manage"><!-- Start Content Box -->
				...
				<div class="content-box-content">
						...
						<table>
							...
							<tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td>
										<!-- Icons -->
										 <a href="/myProject/thinkphpFrame/index.php/Admin/Task/show_edit/id/<?php echo ($vo["id"]); ?>" title="Edit"><img src="/myProject/thinkphpFrame/Public/Admin/resources/images/icons/pencil.png" alt="Edit" /></a>
					...
					<div class="tab-content" id="tab2">
						...
						<form action="/myProject/thinkphpFrame/index.php/Admin/Task/insert" method="post" name="task_form">
							
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->

								<p>
									<label>任务标题</label>
									<input class="text-input medium-input" type="text" id="task_name" name="task_name" /> 
								</p>
								...
								<p>
									<label>招募时间</label>
										<input class="text-input" type="text" id="task_start_time" name="task_start_time" />
									-
										<input class="text-input" type="text" id="task_end_time" name="task_end_time" /> 
								</p>

								<p>
									<label>周期</label>
									<input class="text-input" type="text" id="period" name="period" /> 
								</p>

								<p>
									<label>征车数量</label>
									<input class="text-input" type="text" id="task_car_num" name="task_car_num" /> &nbsp;辆
								</p>
								...
								<p>
									<label>任务酬金</label>
									<input class="text-input" type="text" id="task_money" name="task_money" /> &nbsp;元
								</p>

								<p>
									<label>获得积分</label>
									<input class="text-input" type="text" id="task_jifeng" name="task_jifeng" /> &nbsp;分
								</p>

								<p>
									<label>酬金具体分配</label>
									<input class="text-input medium-input" type="text" id="money_distribute" name="money_distribute" /> 
								</p>

								<p>
									<label>车辆附加要求</label>
									<input class="text-input medium-input" type="text" id="car_append" name="car_append" /> 
								</p>
