...
<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="http://shihai.ft0917.com/mobile/php2Excel2.php?id=<?php echo ($_GET['id']); ?>"><span>
						...
						<table>
							...
							<tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td>
										<!-- Icons -->
										 <a href="#" id="check<?php echo ($vo["id"]); ?>-<?php echo ($_GET['id']); ?>" title="审核"><img src="/myProject/thinkphpFrame/Public/Admin/resources/images/icons/pencil.png" alt="Edit" /></a>
										 <a href="/myProject/thinkphpFrame/index.php/Admin/Task/delete_bm/id/<?php echo ($vo["id"]); ?>/tid/<?php echo ($_GET['id']); ?>" title="Delete" onclick="return confirm_d(this.href);"><img src="/myProject/thinkphpFrame/Public/Admin/resources/images/icons/cross.png" alt="Delete" /></a> 
						...
						$(function(){
						  ...
						  //       }
						  		layer.confirm('你确认要通过审核吗？',{
						  			...
						  			// ajax 提交
									$.post("/myProject/thinkphpFrame/index.php/Admin/Task/checkAjax/userid/"+userid+"/taskid/"+taskid,function(data){
										if (data==1) {
											layer.msg("审核成功!请刷新页面!", {icon:1});
										} else{
											layer.msg("己审核过！");
										};	
									});
