...
<div id="body-wrapper" /> <!-- Wrapper for the radial gradient background -->
	...
	<ul>
		...
		<li><a class="current" href="#">编辑新闻</a></li>
		<li><a href="/myProject/thinkphpFrame/index.php/Admin/News/newsCat">新闻分类</a></li>
		<!--
		<li><a href="#">Manage Pages</a></li> -->
			...
			<div class="content-box" id="member-manage"><!-- Start Content Box -->
				...
				<div class="content-box-content">
						...
						<table>
							...
							<tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td>
										<!-- Icons -->
										 <a href="/myProject/thinkphpFrame/index.php/Admin/News/show_edit/id/<?php echo ($vo["id"]); ?>" title="Edit"><img src="/myProject/thinkphpFrame/Public/Admin/resources/images/icons/pencil.png" alt="Edit" /></a>
										 <a href="/myProject/thinkphpFrame/index.php/Admin/News/delete/id/<?php echo ($vo["id"]); ?>" title="Delete"><img src="/myProject/thinkphpFrame/Public/Admin/resources/images/icons/cross.png" alt="Delete" /></a> 
					...
					<div class="tab-content default-tab" id="tab2">
						...
						<form action="/myProject/thinkphpFrame/index.php/Admin/News/update" method="post" name="news_form">
							
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->

								<p>
									<label>新闻标题</label>
									<input class="text-input medium-input" type="text" id="name" name="name" value="<?php echo ($data["name"]); ?>" /> 
									<input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
								</p>

								<p>
									<input type="button" value="上传图片"><span style="display:none" class="input-notification success png_bg">上传成功</span>
									<input type="hidden" name="news_img_url" id="task_img_url" value="<?php echo ($data["news_img_url"]); ?>">
								</p>

								<p>
									<label>选择分类</label>
									<select name="cat_id">
										<option value="1" <?php if($data["cat_id"] == 1): ?>selected<?php endif; ?>>站内链接</option>
										<option value="2" <?php if($data["cat_id"] == 2): ?>selected<?php endif; ?>>爱车保养</option>
										<option value="3" <?php if($data["cat_id"] == 3): ?>selected<?php endif; ?>>站内新闻</option>
										<option value="4" <?php if($data["cat_id"] == 4): ?>selected<?php endif; ?>>经典案例</option>
									</select>
								</p>
								
								<p>
									<label>新闻内容</label>
									<textarea id="editor_id" name="content" style="width:1100px;height:700px;">
								...
								<p>
									<label>作者：</label>
									<input class="text-input" type="text" id="post_man" name="post_man" value="<?php echo ($data["post_man"]); ?>" />
								</p>
