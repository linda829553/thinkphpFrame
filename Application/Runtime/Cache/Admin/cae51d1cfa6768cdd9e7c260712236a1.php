...
<body>
<div id="layerCut" class="layerCut" style="display: none;"><div id="altContent"></div></div>
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						...
						<li><a href="<?php echo ($nav["member_manage"]); ?>">管理 会员</a></li> <!-- Add class "current" to sub menu items also -->
				...
				<li>
					...
					<ul>
						<li><a class="current"  href="<?php echo ($nav["task_post_url"]); ?>">任务管理</a></li>
						<li><a href="#">发布任务</a></li>
					</ul>
				</li>
			...
			<div class="content-box" id="member-manage"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					...
					<div class="tab-content" id="tab2">
						...
						<form action="#" method="post" name="task_form">
							
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->

								<p>
									<label>任务标题</label>
									<input class="text-input medium-input" type="text" id="task-name" name="task-name" /> <span class="input-notification error png_bg">Error message</span>
								</p>
								...
								<p>
									<label>招募时间</label>
										<input class="text-input" type="text" id="task_startTime" name="task_startTime" />
									-
										<input class="text-input" type="text" id="task_endTime" name="task_endTime" /> 
								</p>

								<p>
									<label>周期</label>
									<input class="text-input" type="text" id="task-period" name="task-period" /> <span class="input-notification error png_bg">Error message</span>
								</p>

								<p>
									<label>征车数量</label>
									<input class="text-input" type="text" id="task-car-num" name="task-car-num" /> <span class="input-notification error png_bg">Error message</span>
								</p>

								<p>
									<label>颜色</label>
									<input class="text-input" type="text" id="task-car-color" name="task-car-color" /> <span class="input-notification error png_bg">Error message</span>
								</p>

								<p>
									<label>任务酬金</label>
									<input class="text-input" type="text" id="task-car-money" name="task-car-money" /> <span class="input-notification error png_bg">Error message</span>
								</p>

								<p>
									<label>获得积分</label>
									<input class="text-input" type="text" id="task-car-jifeng" name="task-car-jifeng" /> <span class="input-notification error png_bg">Error message</span>
								</p>

								<p>
									<label>酬金具体分配</label>
									<input class="text-input medium-input" type="text" id="task-car-jifeng" name="task-car-jifeng" /> <span class="input-notification error png_bg">Error message</span>
								</p>
